...
console.log(
  'This script populates some categories and their items"'
);
...
async function itemCreate(name,description,available,price,category) {
  const itemDetail = { name:name, description:description,available:available,price:price,category:category };
